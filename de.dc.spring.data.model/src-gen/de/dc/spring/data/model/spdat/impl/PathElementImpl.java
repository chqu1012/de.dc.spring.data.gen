 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.spring.data.model.spdat.impl.PathElementImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PathElementImpl extends MinimalEObjectImpl.Container implements PathElement {
	...
	protected EClass eStaticClass() {
		return SpdatPackage.Literals.PATH_ELEMENT;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpdatPackage.PATH_ELEMENT__PATH, oldPath, path));
	}
