/**
 */
package de.dc.spring.data.model.spdat.util;
 ...
 * <!-- end-user-doc -->
 * @see de.dc.spring.data.model.spdat.SpdatPackage
 * @generated
 */
public class SpdatSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SpdatPackage modelPackage;
	...
	public SpdatSwitch() {
		if (modelPackage == null) {
			modelPackage = SpdatPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SpdatPackage.SPRING_PROJECT: {
			...
			if (result == null)
				result = caseNamedElement(springProject);
			if (result == null)
		...
		case SpdatPackage.REPOSITORY: {
			...
			if (result == null)
				result = casePathElement(repository);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpdatPackage.NAMED_ELEMENT: {
		...
		case SpdatPackage.PATH_ELEMENT: {
