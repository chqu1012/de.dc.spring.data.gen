...
/**
 * This is the item provider adapter for a {@link de.dc.spring.data.model.spdat.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider extends NamedElementItemProvider {
	...
	protected void addAssociatedDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Repository_associatedData_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Repository_associatedData_feature",
								"_UI_Repository_type"),
						SpdatPackage.Literals.REPOSITORY__ASSOCIATED_DATA, true, false, true, null, null, null));
	}
